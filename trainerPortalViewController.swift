...
class PortalViewController: SAParallaxViewController {
    let titleList: [String] = ["Clients", "Session", "Calendar", "My Profile"]
    ...
    override func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        let numIcons = titleList.count
        let index = (indexPath as NSIndexPath).row % numIcons
    ...
    override func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        let viewController = PortalDetailViewController()
